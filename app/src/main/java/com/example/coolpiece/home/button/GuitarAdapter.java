...
public class GuitarAdapter extends RecyclerView.Adapter {
    private ArrayList<Guitar> mData=null;
    String cat;
    static Context context;
    public GuitarAdapter(ArrayList<Guitar> mData, String cat){
        this.mData=mData;
        this.cat=cat;
    }
    ...
    public void removeall(ArrayList<Guitar> newData){
        if(mData!=null){
            mData=null;
        }
        mData=newData;
