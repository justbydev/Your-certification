...
public class GisaAdapter extends RecyclerView.Adapter {
    private ArrayList<Gisa> mData=null;
    String cat;
    static Context context;
    public GisaAdapter(ArrayList<Gisa> mData, String cat){
        this.mData=mData;
        this.cat=cat;
    }
    ...
    public void removeall(ArrayList<Gisa> newData){
        if(mData!=null){
            mData=null;
        }
        mData=newData;
